...
function get_export_function_names() {
    echo "$LOGGING_EXPORTED_FUNCTION_NAMES $FILE_EXPORTED_FUNCTION_NAMES $VALIDATE_EXPORTED_FUNCTION_NAMES $BASH_EXPORTED_FUNCTION_NAMES $CUSTOM_EXPORTED_FUNCTION_NAMES $dependencies";
}
